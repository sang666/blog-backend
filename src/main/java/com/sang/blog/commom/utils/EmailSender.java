...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "15500518072@163.com", "GVJATBBTZGGFPVEO");
    }
    ...
    public static void sendRegisterVerifyCode(String code, String address) throws MessagingException {
        EmailSender.subject("博客注册验证码")
                .from("博客")
                .text("宁的验证码是" + code + " 有效期为10分钟，若非本人操作，请忽略此信息")
                .to(address)
                .send();
    }
